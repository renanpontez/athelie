  ...
  return (
    ...
    >
      <div className="flex items-end justify-between gap-6 flex-wrap">
        <div>
          <SectionLabel ordinal="02" label="Projetos selecionados" />
          <h2 className="mt-6 font-display text-[clamp(2rem,4.5vw,3.5rem)] leading-[1.05] max-w-[15ch] reveal-word">
            <span>
              Casas, lojas e escritórios feitos com pensamento.
            </span>
          </h2>
        </div>
        <CTA href="/projetos" variant="underline">
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-20">
        {featured.map((p, i) => (
          ...
          >
            <div
              className={cn(
                "project-image relative overflow-hidden bg-bone-2",
                imageRatios[i]
              )}
            >
              <Image
            ...
            <div className="mt-5 flex items-start justify-between gap-4">
              ...
              <p className="font-mono-label text-stone whitespace-nowrap">
