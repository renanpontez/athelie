...
export function ContactForm({ whatsappUrl, phoneE164 }: Props = {}) {
  ...
  const fieldBase =
    "w-full bg-transparent border-b border-stone/40 pb-3 pt-1 text-ink placeholder:text-stone/70 focus:border-ink outline-none transition-colors duration-300";
  ...
  return (
    <form onSubmit={onSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-8">
      ...
      <div className="md:col-span-2">
        <label htmlFor="message" className="font-mono-label text-stone block mb-2">
          Mensagem
        </label>
        <textarea
          id="message"
      ...
      <div className="md:col-span-2 flex flex-wrap items-center justify-between gap-6 pt-4">
        ...
        <button
          type="submit"
          className="group inline-flex items-center gap-3 rounded-full bg-ink px-7 py-3.5 text-sm tracking-wide text-bone transition-colors duration-500 hover:bg-sage-dark"
        >
