  ...
  if (variant === "primary") {
    return (
      <Component
        {...props}
        className={cn(
          "group inline-flex items-center gap-3 rounded-full bg-ink px-7 py-3.5 text-sm tracking-wide text-bone transition-colors duration-500 hover:bg-sage-dark",
          className
        )}
      >
